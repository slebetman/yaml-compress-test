...
import { displayHistory, initJsonEditor, setHistoryIndex } from './json-editor.mjs';
...
window.addEventListener('load', () => {
	$('#loadSample').onclick = () => {
		...
		history.editHistory.splice(0,history.editHistory.length);
		[].push.apply(history.editHistory,sampleHistory);
		setHistoryIndex(history.editHistoryEnd())
		displayHistory();
	}
})